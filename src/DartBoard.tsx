...
const DartBoard = () => {
  ...
  const handleSegmentClick = (number: number, multiplier: number) => {
    console.log(`Clicked: ${multiplier}x${number} = ${multiplier * number}`);
  };
            ...
            return (
              <>
                ...
                <path
                  ...
                  onClick={() => handleSegmentClick(number, 1)}
                />
                ...
                <path
                  ...
                  stroke-width="1"
                  class="cursor-pointer hover:opacity-80"
                  onClick={() => handleSegmentClick(number, 2)}
                />
                ...
                <path
                  ...
                  stroke-width="1"
                  class="cursor-pointer hover:opacity-80"
                  onClick={() => handleSegmentClick(number, 3)}
                />
